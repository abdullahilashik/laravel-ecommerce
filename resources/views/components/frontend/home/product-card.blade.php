    ...
    <div>
        <div class="h-52 bg-gray-50 rounded-xl mb-4 flex items-center justify-center overflow-hidden relative">
            ...
            <div class="absolute top-3 right-3 flex flex-col space-y-2 opacity-0 group-hover:opacity-100 transition duration-200">
                ...
                <a aria-label="Quick view" class="action-btn w-8 h-8 bg-white rounded-full shadow flex items-center justify-center hover:bg-emerald-50 hover:text-emerald-500 text-gray-400 text-sm quickview-btn" href="#" data-bs-toggle="modal" data-bs-target="#quickViewModal" data-product-slug="{{ $product->slug }}">
